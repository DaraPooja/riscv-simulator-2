 ...
 */
 ...
 alu::AluOp RVSSControlUnit::GetAluSignal(uint32_t instruction, bool ALUOp) {
     ...
     // F extension + D extension
     // FMADD family - return appropriate ALU op
     case 0b1000011: {// FMADD
         switch (funct2) {
             case 0b00: return alu::AluOp::kFmadd_s;   // Single precision
             case 0b01: return alu::AluOp::FMADD_D;    // Double precision
             default: return alu::AluOp::kFmadd_s;
         }
     }
     case 0b1000111: {// FMSUB
         switch (funct2) {
             case 0b00: return alu::AluOp::kFmsub_s;
             case 0b01: return alu::AluOp::FMSUB_D;
             default: return alu::AluOp::kFmsub_s;
         }
     }
     case 0b1001011: { // FNMSUB
        switch (funct2) {
            ...
            default:   return alu::AluOp::kFnmsub_s;
        }
    }
    ...
    case 0b1001111: { // FNMADD
        switch (funct2) {
            ...
            default:   return alu::AluOp::kFnmadd_s;
        }
    }    
     ...
     case 0b1010011: {
         switch (funct7) {
             ...
             case 0b0100000: { // FCVT.S.D (double to single)
                switch (funct5) {
                    case 0b00001:{ // FCVT.S.D (double → single)
                        auto op = alu::AluOp::FCVT_S_D;
                        return op;
                    }
                    ...
                    default:
                        return alu::AluOp::FCVT_S_D;
                }
            }
            
            case 0b0100001: { // FCVT.D.S (single to double)
                switch (funct5) {
                    case 0b00000: { // FCVT.D.S (single → double)
                        auto op = alu::AluOp::FCVT_D_S;
                        return op;
                    }
